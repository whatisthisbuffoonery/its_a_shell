...
- [My own pipex README for pipeline and PATH semantics without considering signals](https://github.com/whatisthisbuffoonery/temp/blob/main/uwu/pipex/README.md)  
